...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 12 22:18:19 2023
...
def human_turn(c_choice, h_choice):
    """
    Initiates the human player's turn.
    """
    depth = len(empty_cells(board))
    if depth == 0 or game_over(board):
        return
    ...
    while True:
        try:
            ...
            break  # Break the loop on successful move
...
def main():
   ...
   while h_choice != 'O' and h_choice != 'X':
       try:
           ...
           print('Bye')
          # system.exit() # Change made here from exit() to current
       except (KeyError, ValueError):
           print('Bad choice')
